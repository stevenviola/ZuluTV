bt.progressManager = (function() {
  ...
  return {
    ...
    createBar: function(settings, callback) {
      arguments.callee['✓']('createBar', arguments, 'OF', [1,2]);
      (function(id, elem) {
        arguments.callee['✓']('createBar settings test', arguments, 'SElem');
      ...
      if ('object' !== typeof jQuery.ui ||
        ...
        if (!$(bar).hasClass('ui-progressbar') || $(bar).get(0) !== $(settings.elem).get(0)) {
    ...
    updateBar: function(id) {
      arguments.callee['✓']('updateBar', arguments, 'S');
      bars[id].progressbar({
    ...
    keepBarUpdated: function(id) {
      arguments.callee['✓']('keepBarUpdated', arguments, 'S');
